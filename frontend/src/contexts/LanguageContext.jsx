...
const translations = {
  en: {
    ...
    'auth.forgotPasswordSubtitle': 'Enter your email and we will send you a link to reset your password.',
    'auth.sendResetLink': 'Send reset link',
    'auth.resetLinkSent': 'If that email exists, a reset link has been sent.',
    'auth.resetRequestFailed': 'Unable to send reset link. Please try again.',
    'auth.resetPasswordTitle': 'Reset Password',
    'auth.resetPasswordSubtitle': 'Create a new password for your teacher account.',
    'auth.resetTokenMissing': 'Reset token is missing. Please request a new link.',
    'auth.passwordResetSuccess': 'Password updated successfully. You can now log in with your new password.',
    'auth.passwordResetFailed': 'Unable to reset password. The link may have expired.',
